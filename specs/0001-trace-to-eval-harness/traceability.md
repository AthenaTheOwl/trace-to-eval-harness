...
| R-TTE-SCHEMA-005 | owner_role: engineering.implementation | `schemas/run-evidence.schema.json`, `tests/fixtures/valid/run_evidence.json`, `tests/fixtures/invalid/run_evidence_missing_refs.json` |
